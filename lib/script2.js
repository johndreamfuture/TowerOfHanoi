...
function liftL() {
  ...
  console.log(circlecontainer[0].firstElementChild)
  // console.log(circlecontainer[0].firstElementChild.dataset.weight)
...
function dropL() {
  ...
  if (circlecontainer[0].lastElementChild == null || (placeholder.dataset.weight < circlecontainer[0].lastElementChild.dataset.weight)) {
    // circlecontainer[0].lastElementChild.insertAdjacentElement("afterend", placeholder)
    circlecontainer[0].appendChild(placeholder)
    placeholder = 0;
    console.log(num)
    num++
    console.log(num)
    counter.innerHTML = num;
    if (circlecontainer[0].childNodes.length === 6) {
...
function dropM() {
  ...
  if (circlecontainer[1].hasChildNodes()) {
    console.log(circlecontainer[1].lastElementChild.dataset.weight)
  }

  // circlecontainer[0].lastElementChild = placeholder

  if (circlecontainer[1].lastElementChild == null || (placeholder.dataset.weight < circlecontainer[1].lastElementChild.dataset.weight)) {
    circlecontainer[1].appendChild(placeholder)
    placeholder = 0;
    num++
    counter.innerHTML = num;
    if (circlecontainer[1].childNodes.length === 6) {
      message.innerText = "Great job!"
    }
  }
...
//right
circlecontainer[2].addEventListener("click", moveR)


function liftR() {
  if (circlecontainer[2].hasChildNodes()) {
    console.log("lift-R")
    placeholder = circlecontainer[2].lastElementChild
    place.appendChild(placeholder)
    console.log(placeholder)
  }
...
function dropR() {
  console.log("drop-R")
  console.log(circlecontainer[2])
  // circlecontainer[0].lastElementChild = placeholder
  if (circlecontainer[2].lastElementChild == null || (placeholder.dataset.weight < circlecontainer[2].lastElementChild.dataset.weight)) {
    circlecontainer[2].appendChild(placeholder)
    placeholder = 0;
    num++
    counter.innerHTML = num;
    if (circlecontainer[2].childNodes.length === 6) {
      message.innerText = "Great job!"
    }
  }
